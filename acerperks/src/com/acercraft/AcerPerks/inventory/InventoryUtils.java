...
public class InventoryUtils
{
  ...
  public static Inventory stringToInventory(String data) {
    ...
    try
    {
      ...
      Method getMethod = class_NBTTagList.getMethod("get", new Class[] { Integer.TYPE });
      ...
      Method setItemMethod = class_CraftInventoryCustom.getMethod("setItem", new Class[] { Integer.TYPE, ItemStack.class });
  ...
  public static Inventory createInventory(InventoryHolder holder, int size) {
    Inventory inventory = null;
    try {
      Constructor<?> inventoryConstructor = class_CraftInventoryCustom.getConstructor(new Class[] { InventoryHolder.class, Integer.TYPE });
